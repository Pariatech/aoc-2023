...
pub const struct_sqlite3_io_methods = extern struct {
    iVersion: c_int,
    xClose: ?*const fn ([*c]sqlite3_file) callconv(.C) c_int,
    xRead: ?*const fn ([*c]sqlite3_file, ?*anyopaque, c_int, sqlite3_int64) callconv(.C) c_int,
    xWrite: ?*const fn ([*c]sqlite3_file, ?*const anyopaque, c_int, sqlite3_int64) callconv(.C) c_int,
    xTruncate: ?*const fn ([*c]sqlite3_file, sqlite3_int64) callconv(.C) c_int,
    xSync: ?*const fn ([*c]sqlite3_file, c_int) callconv(.C) c_int,
    xFileSize: ?*const fn ([*c]sqlite3_file, [*c]sqlite3_int64) callconv(.C) c_int,
    xLock: ?*const fn ([*c]sqlite3_file, c_int) callconv(.C) c_int,
    xUnlock: ?*const fn ([*c]sqlite3_file, c_int) callconv(.C) c_int,
    xCheckReservedLock: ?*const fn ([*c]sqlite3_file, [*c]c_int) callconv(.C) c_int,
    xFileControl: ?*const fn ([*c]sqlite3_file, c_int, ?*anyopaque) callconv(.C) c_int,
    xSectorSize: ?*const fn ([*c]sqlite3_file) callconv(.C) c_int,
    xDeviceCharacteristics: ?*const fn ([*c]sqlite3_file) callconv(.C) c_int,
    xShmMap: ?*const fn ([*c]sqlite3_file, c_int, c_int, c_int, [*c]?*volatile anyopaque) callconv(.C) c_int,
    xShmLock: ?*const fn ([*c]sqlite3_file, c_int, c_int, c_int) callconv(.C) c_int,
    xShmBarrier: ?*const fn ([*c]sqlite3_file) callconv(.C) void,
    xShmUnmap: ?*const fn ([*c]sqlite3_file, c_int) callconv(.C) c_int,
    xFetch: ?*const fn ([*c]sqlite3_file, sqlite3_int64, c_int, [*c]?*anyopaque) callconv(.C) c_int,
    xUnfetch: ?*const fn ([*c]sqlite3_file, sqlite3_int64, ?*anyopaque) callconv(.C) c_int,
};
...
pub const struct_sqlite3_vfs = extern struct {
    ...
    zName: [*c]const u8,
    pAppData: ?*anyopaque,
    xOpen: ?*const fn ([*c]sqlite3_vfs, sqlite3_filename, [*c]sqlite3_file, c_int, [*c]c_int) callconv(.C) c_int,
    xDelete: ?*const fn ([*c]sqlite3_vfs, [*c]const u8, c_int) callconv(.C) c_int,
    xAccess: ?*const fn ([*c]sqlite3_vfs, [*c]const u8, c_int, [*c]c_int) callconv(.C) c_int,
    xFullPathname: ?*const fn ([*c]sqlite3_vfs, [*c]const u8, c_int, [*c]u8) callconv(.C) c_int,
    xDlOpen: ?*const fn ([*c]sqlite3_vfs, [*c]const u8) callconv(.C) ?*anyopaque,
    xDlError: ?*const fn ([*c]sqlite3_vfs, c_int, [*c]u8) callconv(.C) void,
    xDlSym: ?*const fn ([*c]sqlite3_vfs, ?*anyopaque, [*c]const u8) callconv(.C) ?*const fn () callconv(.C) void,
    xDlClose: ?*const fn ([*c]sqlite3_vfs, ?*anyopaque) callconv(.C) void,
    xRandomness: ?*const fn ([*c]sqlite3_vfs, c_int, [*c]u8) callconv(.C) c_int,
    xSleep: ?*const fn ([*c]sqlite3_vfs, c_int) callconv(.C) c_int,
    xCurrentTime: ?*const fn ([*c]sqlite3_vfs, [*c]f64) callconv(.C) c_int,
    xGetLastError: ?*const fn ([*c]sqlite3_vfs, c_int, [*c]u8) callconv(.C) c_int,
    xCurrentTimeInt64: ?*const fn ([*c]sqlite3_vfs, [*c]sqlite3_int64) callconv(.C) c_int,
    xSetSystemCall: ?*const fn ([*c]sqlite3_vfs, [*c]const u8, sqlite3_syscall_ptr) callconv(.C) c_int,
    xGetSystemCall: ?*const fn ([*c]sqlite3_vfs, [*c]const u8) callconv(.C) sqlite3_syscall_ptr,
    xNextSystemCall: ?*const fn ([*c]sqlite3_vfs, [*c]const u8) callconv(.C) [*c]const u8,
};
...
pub const struct_sqlite3_module = extern struct {
    iVersion: c_int,
    xCreate: ?*const fn (?*sqlite3, ?*anyopaque, c_int, [*c]const [*c]const u8, [*c][*c]sqlite3_vtab, [*c][*c]u8) callconv(.C) c_int,
    xConnect: ?*const fn (?*sqlite3, ?*anyopaque, c_int, [*c]const [*c]const u8, [*c][*c]sqlite3_vtab, [*c][*c]u8) callconv(.C) c_int,
    xBestIndex: ?*const fn ([*c]sqlite3_vtab, [*c]sqlite3_index_info) callconv(.C) c_int,
    xDisconnect: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xDestroy: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xOpen: ?*const fn ([*c]sqlite3_vtab, [*c][*c]sqlite3_vtab_cursor) callconv(.C) c_int,
    xClose: ?*const fn ([*c]sqlite3_vtab_cursor) callconv(.C) c_int,
    xFilter: ?*const fn ([*c]sqlite3_vtab_cursor, c_int, [*c]const u8, c_int, [*c]?*sqlite3_value) callconv(.C) c_int,
    xNext: ?*const fn ([*c]sqlite3_vtab_cursor) callconv(.C) c_int,
    xEof: ?*const fn ([*c]sqlite3_vtab_cursor) callconv(.C) c_int,
    xColumn: ?*const fn ([*c]sqlite3_vtab_cursor, ?*sqlite3_context, c_int) callconv(.C) c_int,
    xRowid: ?*const fn ([*c]sqlite3_vtab_cursor, [*c]sqlite3_int64) callconv(.C) c_int,
    xUpdate: ?*const fn ([*c]sqlite3_vtab, c_int, [*c]?*sqlite3_value, [*c]sqlite3_int64) callconv(.C) c_int,
    xBegin: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xSync: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xCommit: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xRollback: ?*const fn ([*c]sqlite3_vtab) callconv(.C) c_int,
    xFindFunction: ?*const fn ([*c]sqlite3_vtab, c_int, [*c]const u8, [*c]?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, [*c]?*anyopaque) callconv(.C) c_int,
    xRename: ?*const fn ([*c]sqlite3_vtab, [*c]const u8) callconv(.C) c_int,
    xSavepoint: ?*const fn ([*c]sqlite3_vtab, c_int) callconv(.C) c_int,
    xRelease: ?*const fn ([*c]sqlite3_vtab, c_int) callconv(.C) c_int,
    xRollbackTo: ?*const fn ([*c]sqlite3_vtab, c_int) callconv(.C) c_int,
    xShadowName: ?*const fn ([*c]const u8) callconv(.C) c_int,
    xIntegrity: ?*const fn ([*c]sqlite3_vtab, [*c]const u8, [*c]const u8, c_int, [*c][*c]u8) callconv(.C) c_int,
};
...
pub const struct_sqlite3_mutex_methods = extern struct {
    ...
    xMutexAlloc: ?*const fn (c_int) callconv(.C) ?*sqlite3_mutex,
    xMutexFree: ?*const fn (?*sqlite3_mutex) callconv(.C) void,
    xMutexEnter: ?*const fn (?*sqlite3_mutex) callconv(.C) void,
    xMutexTry: ?*const fn (?*sqlite3_mutex) callconv(.C) c_int,
    xMutexLeave: ?*const fn (?*sqlite3_mutex) callconv(.C) void,
    xMutexHeld: ?*const fn (?*sqlite3_mutex) callconv(.C) c_int,
    xMutexNotheld: ?*const fn (?*sqlite3_mutex) callconv(.C) c_int,
};
...
pub const struct_sqlite3_pcache_methods2 = extern struct {
    ...
    xInit: ?*const fn (?*anyopaque) callconv(.C) c_int,
    xShutdown: ?*const fn (?*anyopaque) callconv(.C) void,
    xCreate: ?*const fn (c_int, c_int, c_int) callconv(.C) ?*sqlite3_pcache,
    xCachesize: ?*const fn (?*sqlite3_pcache, c_int) callconv(.C) void,
    xPagecount: ?*const fn (?*sqlite3_pcache) callconv(.C) c_int,
    xFetch: ?*const fn (?*sqlite3_pcache, c_uint, c_int) callconv(.C) [*c]sqlite3_pcache_page,
    xUnpin: ?*const fn (?*sqlite3_pcache, [*c]sqlite3_pcache_page, c_int) callconv(.C) void,
    xRekey: ?*const fn (?*sqlite3_pcache, [*c]sqlite3_pcache_page, c_uint, c_uint) callconv(.C) void,
    xTruncate: ?*const fn (?*sqlite3_pcache, c_uint) callconv(.C) void,
    xDestroy: ?*const fn (?*sqlite3_pcache) callconv(.C) void,
    xShrink: ?*const fn (?*sqlite3_pcache) callconv(.C) void,
};
...
pub const struct_sqlite3_pcache_methods = extern struct {
    ...
    xInit: ?*const fn (?*anyopaque) callconv(.C) c_int,
    xShutdown: ?*const fn (?*anyopaque) callconv(.C) void,
    xCreate: ?*const fn (c_int, c_int) callconv(.C) ?*sqlite3_pcache,
    xCachesize: ?*const fn (?*sqlite3_pcache, c_int) callconv(.C) void,
    xPagecount: ?*const fn (?*sqlite3_pcache) callconv(.C) c_int,
    xFetch: ?*const fn (?*sqlite3_pcache, c_uint, c_int) callconv(.C) ?*anyopaque,
    xUnpin: ?*const fn (?*sqlite3_pcache, ?*anyopaque, c_int) callconv(.C) void,
    xRekey: ?*const fn (?*sqlite3_pcache, ?*anyopaque, c_uint, c_uint) callconv(.C) void,
    xTruncate: ?*const fn (?*sqlite3_pcache, c_uint) callconv(.C) void,
    xDestroy: ?*const fn (?*sqlite3_pcache) callconv(.C) void,
};
...
pub const struct_Fts5ExtensionApi = extern struct {
    ...
    xRowCount: ?*const fn (?*Fts5Context, [*c]sqlite3_int64) callconv(.C) c_int,
    xColumnTotalSize: ?*const fn (?*Fts5Context, c_int, [*c]sqlite3_int64) callconv(.C) c_int,
    xTokenize: ?*const fn (?*Fts5Context, [*c]const u8, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, [*c]const u8, c_int, c_int, c_int) callconv(.C) c_int) callconv(.C) c_int,
    xPhraseCount: ?*const fn (?*Fts5Context) callconv(.C) c_int,
    xPhraseSize: ?*const fn (?*Fts5Context, c_int) callconv(.C) c_int,
    xInstCount: ?*const fn (?*Fts5Context, [*c]c_int) callconv(.C) c_int,
    xInst: ?*const fn (?*Fts5Context, c_int, [*c]c_int, [*c]c_int, [*c]c_int) callconv(.C) c_int,
    xRowid: ?*const fn (?*Fts5Context) callconv(.C) sqlite3_int64,
    xColumnText: ?*const fn (?*Fts5Context, c_int, [*c][*c]const u8, [*c]c_int) callconv(.C) c_int,
    xColumnSize: ?*const fn (?*Fts5Context, c_int, [*c]c_int) callconv(.C) c_int,
    xQueryPhrase: ?*const fn (?*Fts5Context, c_int, ?*anyopaque, ?*const fn ([*c]const Fts5ExtensionApi, ?*Fts5Context, ?*anyopaque) callconv(.C) c_int) callconv(.C) c_int,
    ...
    xPhraseFirst: ?*const fn (?*Fts5Context, c_int, [*c]Fts5PhraseIter, [*c]c_int, [*c]c_int) callconv(.C) c_int,
    xPhraseNext: ?*const fn (?*Fts5Context, [*c]Fts5PhraseIter, [*c]c_int, [*c]c_int) callconv(.C) void,
    xPhraseFirstColumn: ?*const fn (?*Fts5Context, c_int, [*c]Fts5PhraseIter, [*c]c_int) callconv(.C) c_int,
    xPhraseNextColumn: ?*const fn (?*Fts5Context, [*c]Fts5PhraseIter, [*c]c_int) callconv(.C) void,
};
...
pub const struct_fts5_api = extern struct {
    iVersion: c_int,
    xCreateTokenizer: ?*const fn ([*c]fts5_api, [*c]const u8, ?*anyopaque, [*c]fts5_tokenizer, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int,
    xFindTokenizer: ?*const fn ([*c]fts5_api, [*c]const u8, [*c]?*anyopaque, [*c]fts5_tokenizer) callconv(.C) c_int,
    xCreateFunction: ?*const fn ([*c]fts5_api, [*c]const u8, ?*anyopaque, fts5_extension_function, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int,
};
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /Users/gabrielpariat/dev/homebrew/Cellar/zig/0.11.0/lib/zig/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /Users/gabrielpariat/dev/homebrew/Cellar/zig/0.11.0/lib/zig/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // /Users/gabrielpariat/dev/homebrew/Cellar/zig/0.11.0/lib/zig/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /Users/gabrielpariat/dev/homebrew/Cellar/zig/0.11.0/lib/zig/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /Users/gabrielpariat/dev/homebrew/Cellar/zig/0.11.0/lib/zig/include/stdarg.h:46:9
pub const SQLITE_EXTERN = @compileError("unable to translate C expr: unexpected token 'extern'"); // /Users/gabrielpariat/dev/aoc/sqlite/sqlite3.h:72:10
...
pub const SQLITE_VERSION = "3.44.2";
pub const SQLITE_VERSION_NUMBER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 3044002, .decimal);
pub const SQLITE_SOURCE_ID = "2023-11-24 11:41:44 ebead0e7230cd33bcec9f95d2183069565b9e709bf745c9b5db65cc0cbf92c0f";
...
pub const SQLITE_RESULT_SUBTYPE = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x001000000, .hexadecimal);
